...
import static com.example.quizonline.SetsActivity.category_id;
import static com.example.quizonline.SetsActivity.setsIDs;
        ...
        firestore.collection("QUIZ").document("CAT" + String.valueOf(category_id))
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.d("loggg",String.valueOf(questions.size()));
